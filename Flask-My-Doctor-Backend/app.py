...
from routes.health_diagnosis import health_diagnosis_bp
from routes.risk_prediction import risk_predictor_bp
...
app.register_blueprint(health_diagnosis_bp)
app.register_blueprint(risk_predictor_bp)
